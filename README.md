...
| `verificar_lembretes` | A cada 1 min | Envia lembrete WhatsApp para consultas confirmadas próximas de acontecer |
...
Scheduler (processo separado):
  - verificar_lembretes: envia lembrete ~na hora da consulta
