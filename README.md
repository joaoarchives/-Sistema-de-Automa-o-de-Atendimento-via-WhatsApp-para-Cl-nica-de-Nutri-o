...
- ele só envia lembretes em duas janelas:
  - 24 horas antes da consulta
  - 12 horas antes da consulta
- o controle de duplicidade é explícito por consulta:
  - `lembrete_24h_enviado`
  - `lembrete_12h_enviado`
- consultas canceladas, não confirmadas ou já passadas não recebem lembrete
